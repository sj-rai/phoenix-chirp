defmodule PhoenixChirp.TimelineTest do
  use PhoenixChirp.DataCase

  alias PhoenixChirp.Timeline

  describe "posts" do
    alias PhoenixChirp.Timeline.Post

    import PhoenixChirp.TimelineFixtures
